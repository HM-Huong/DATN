...
//	.clk    (clk                      ),
//	.reset  (reset                    ),
//	.cs     (cs_array[`S7_AES128]      ),
//	.read   (mem_rd_array[`S7_AES128]  ),
//	.write  (mem_wr_array[`S7_AES128]  ),
//	.addr   (reg_addr_array[`S7_AES128]),
//	.rd_data(rd_data_array[`S7_AES128] ),
//	.wr_data(wr_data_array[`S7_AES128] )
//);
