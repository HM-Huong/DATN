module text_core #(parameter
	...
	input  logic [CD-1:0] front_rgb,
	input  logic [CD-1:0] back_rgb ,
	// pixel output
	...
	logic [ 7:0] ch_d1_reg ;
	// delay line
	logic [2:0] x_delay1_reg;
	logic [2:0] x_delay2_reg;
	...
	assign osd_rgb = (ch_d1_reg[6:0]==NULL_CHAR) ? CHROMA_KEY : p_rgb;
endmodule
